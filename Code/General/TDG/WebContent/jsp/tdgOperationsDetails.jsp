										...
										<c:if test="${not empty dContent.listDynamicPojo}">
											...
											<tr>
												...
												<td class="field-title" width="20%" align="left"
													...
													name='${myIndex.index+1}GenerateType'>
														<option title="${myIndex.index+1}GenerateType" value="DB">DB</option>
														<option title="${myIndex.index+1}GenerateType" value="XLS">XLS</option>
														<option title="${myIndex.index+1}GenerateType" value="CSV">CSV</option>
														<option title="${myIndex.index+1}GenerateType" value="XLSFL">XLSFL</option>
														<option title="${myIndex.index+1}GenerateType" value="CSVFL">CSVFL</option>
														<option title="${myIndex.index+1}GenerateType" value="XML">XML</option>
												</select></td>
											</tr>
											<tr>
												<td class="label-title" width="35%" align="left"
												...
												<td class="field-title" width="20%" align="left"
													valign="middle"><select
													name='${myIndex.index+1}RequiredAllColumns'>
														<option title="${myIndex.index+1}RequiredAllColumns" value="NO">No</option>
														<option title="${myIndex.index+1}RequiredAllColumns" value="YES">Yes</option>
												</select></td>
											</tr>
											<tr>
												<td class="lable-title" width="35%" align="left"
