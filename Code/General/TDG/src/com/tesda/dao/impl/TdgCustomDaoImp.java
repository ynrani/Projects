                            ...
                            for(long i2 = 0;i2 < iLoop;i2++){
    							...
    							logger.info(strClassName + strMethodName
    								...
    								try {
    									...
    									if(lstSequenceColsAndRequired != null && !lstSequenceColsAndRequired.isEmpty())
    									cach = new StringBuffer(CSVGenerator.getCSVForObjects(mapPositions, iRequiredRecordCount, listParameters,lstSequenceColsAndRequired,mapColumnsOfTab));
    									//follwing Enterprise version
    									else
    									cach = new StringBuffer(CSVGenerator.getCSVForList(lstObject,mapColumnsOfTab));
    									if(cach != null)
