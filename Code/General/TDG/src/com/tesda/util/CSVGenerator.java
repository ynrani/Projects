...
public class CSVGenerator{
	...
	public static String getCSVForObjects(Map<Integer, String> colvalMap, Long count, List<Object[]> list,List<String> listSequenceOfColumns, Map<String, String> mapColumnsOfTab){
		StringBuffer sb = new StringBuffer();
	...
	public static String getCSVForList(List<Object[]> list, Map<String, String> mapColumnsOfTab){
		StringBuffer sb = new StringBuffer();
		/*for (int iSize = 1; iSize<colvalMap.size();iSize++) {
			sb.append(colvalMap.get(iSize));
			sb.append('~');
