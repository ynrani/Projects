...
public class TdgDerbyConstant extends TdgCentralConstant{
	...
	public static final String DERBY_GET_ALL_TABLES = "select tablename as table_name from sys.systables";
	public static final String DERBY_GET_ALL_COLUMNS = "select tablename as table_name,columnname as column_name from sys.systables t,sys.syscolumns  where tableid=referenceid";
	public static final String DERBY_GET_ALL_COLUMNS_BY_TAB = "select tablename as table_name,columnname as column_name from sys.systables t,sys.syscolumns  where tableid=referenceid and tablename in ({0})";
