...
public class TdgOracleConstant extends TdgCentralConstant{
	...
	public static final String ORACLE_GET_COLUMN_LENGTHS = "select Column_name,DATA_PRECISION,CHAR_LENGTH from USER_TAB_COLS where table_name='{0}' order by COLUMN_ID";
}
