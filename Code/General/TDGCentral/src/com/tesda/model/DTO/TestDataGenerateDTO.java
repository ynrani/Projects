...
public class TestDataGenerateDTO extends AbstractBaseDTO{
	...
	private List<String> dataConditionalTabNames;
	...
	public List<String> getDataConditionalTabNames(){
		return dataConditionalTabNames;
	}

	public void setDataConditionalTabNames(List<String> dataConditionalTabNames){
