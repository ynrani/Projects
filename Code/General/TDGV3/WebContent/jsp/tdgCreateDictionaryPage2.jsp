...
<script type="text/javascript" src="js/script.js"></script>
  ...
  $(document).ready(function(){
		  ...
		  if(str.toLowerCase().indexOf("$") >= 0){
			  ...
			  for(var j=0;j<strArraymain.length;j++){
				  ...
				  if(strArray.length != 4)
					  strArray[3]='';
				  var markup = "<tr><td style='border: 1px solid #cdcdcd;' align='left'><input type='checkbox' name='record' title='"+strArray[0]+"'></td><td style='border: 1px solid #cdcdcd;' align='left'>" + strArray[0] + "</td><td style='border: 1px solid #cdcdcd;' align='left'>" + strArray[1] + "</td><td style='border: 1px solid #cdcdcd;' align='left'>"+strArray[2]+"</td><td style='border: 1px solid #cdcdcd;' align='left' title='"+strArray[0]+"TDG_HASH"+strArray[1]+"TDG_HASH"+strArray[2]+"TDG_HASH"+strArray[3]+"'>"+strArray[3]+"</td></tr>";
      ...
      $("#add-row").click(function(){
          ...
          $("#columnName option[value='"+name+"']").remove();
          var markup = "<tr><td style='border: 1px solid #cdcdcd;' align='left'><input type='checkbox' name='record' title='"+appendName+"'></td><td style='border: 1px solid #cdcdcd;' align='left'>" + appendName + "</td><td style='border: 1px solid #cdcdcd;' align='left'>" + displaylabel + "</td><td style='border: 1px solid #cdcdcd;' align='left'>"+type+"</td><td style='border: 1px solid #cdcdcd;' align='left' title='"+appendName+"TDG_HASH"+displaylabel+"TDG_HASH"+type+"TDG_HASH"+values+"'>"+values+"</td></tr>";
          //$("table tbody").append(markup);
          $('#fileTable > tbody:last-child').append(markup);
          $("#displayLabel").val('');
          $("#values").val('');
