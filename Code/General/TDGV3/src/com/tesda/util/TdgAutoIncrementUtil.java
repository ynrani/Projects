...
public class TdgAutoIncrementUtil extends TDGBaseUtil{
	...
	public static List<String> generateAutoIncrementValues(String inputValue,long itotalRequired){
		...
		if(inputValue.matches(regexForNumbers) && (!inputValue.startsWith("0") || "0".equalsIgnoreCase(inputValue))){
	...
	public static void main(String[] args){
		System.out.println(TdgAutoIncrementUtil.generateAutoIncrementValues("000001", 100000));
	}
}
