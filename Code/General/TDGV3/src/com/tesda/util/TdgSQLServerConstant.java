...
public class TdgSQLServerConstant extends TdgCentralConstant{
	...
	public static final String SQLSERVER_GET_AUTO_INCREMENT_COLUMNS="select COLUMN_NAME, TABLE_NAME from INFORMATION_SCHEMA.COLUMNS where TABLE_SCHEMA = 'dbo' and COLUMNPROPERTY(object_id(TABLE_NAME), COLUMN_NAME, 'IsIdentity') = 1";
