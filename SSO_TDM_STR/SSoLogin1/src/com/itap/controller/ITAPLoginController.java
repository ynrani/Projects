...
import com.itap.handler.CookieUtil1;
...
public class ITAPLoginController {
	...
	public ModelAndView login(@RequestParam(value = ITAPConstants.ERROR, required = false) String error,
			@RequestParam(value = ITAPConstants.LOGOUT, required = false) String logout) {

		LOGGER.info(ITAPConstants.REMS_LOGIN_CTLR + ITAPConstants.REMS_LOGIN_CTLR_GET + ITAPConstants.REMS_LOGIN_CTLR_YES + error);
		...
		LOGGER.info(ITAPConstants.REMS_LOGIN_CTLR + ITAPConstants.REMS_LOGIN_CTLR_GET + ITAPConstants.REMS_LOGIN_CTLR_YES);
		return model;
	}
	...
	public String login(ModelMap model, HttpServletRequest request, HttpServletResponse response) {
		LOGGER.info(ITAPConstants.REMS_LOGIN_CTLR + ITAPConstants.REMS_LOGIN_CTLR_GET + ITAPConstants.REMS_LOGIN_CTLR_NO);
		return "itaplogin";
	}
	...
	public String logout(ModelMap model, Principal principal, HttpServletRequest request, HttpServletResponse response) {
		LOGGER.info(ITAPConstants.REMS_LOGIN_CTLR + ITAPConstants.REMS_LOGOUT_CTLR_GET + ITAPConstants.REMS_LOGOUT_CTLR_NO);
		...
		CookieUtil1.clear(response, jwtTokenCookieName);
		LOGGER.info(ITAPConstants.REMS_LOGIN_CTLR + ITAPConstants.REMS_LOGOUT_CTLR_GET + ITAPConstants.REMS_LOGOUT_CTLR_NO);
		return ITAPConstants.REMS_LOGIN_VIEW;
	}
