...
public class UserAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException {
		...
		clearAuthenticationAttributes(response, request, authentication);
	}
	...
	protected void clearAuthenticationAttributes(HttpServletResponse httpServletResponse, HttpServletRequest request, Authentication authentication) {
		...
		String token = JwtUtil1.generateToken(signingKey, username);
		CookieUtil1.create(httpServletResponse, jwtTokenCookieName, token, false, -1, "localhost");
